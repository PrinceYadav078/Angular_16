...
export class ProductComponent {
  ...
  searchText: any = "mens wear"

  name = "Tushar"
  inputele = 'Prince YAdav'
  addtocart: number = 0
  product = {
    ...
    discount: 17,
    instock: 20,
    pimg: "/assets/images/iphone14.jfif"
  }
  ...
  emparr: string[] = ["prince", "tushar", "shrijay", "yash", "shaurav"]
  ...
  totaloutofstock= this.products.filter(p=> !p.is_in_inventory).length

  selectedFilteredRadioButton:string='all'

  onFilterChange(val:string){
    
    this.selectedFilteredRadioButton=val;
